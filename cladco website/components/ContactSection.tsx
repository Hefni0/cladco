...
export default function ContactSection() {
  ...
  return (
    <section className="py-20 md:py-24" style={{ background: "#141414", borderTop: "1px solid rgba(155,163,158,0.2)" }}>
      <div className="max-w-6xl mx-auto px-5 md:px-8">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex gap-4">
            <div className="w-10 h-10 flex items-center justify-center shrink-0 mt-0.5" style={{ background: "#1C1C1C", border: "1px solid rgba(155,163,158,0.2)", color: "#9BA39E" }}>
              <LocationIcon />
            </div>
            <div>
          ...
          <motion.div variants={fadeUp} className="flex gap-4">
            <div className="w-10 h-10 flex items-center justify-center shrink-0 mt-0.5" style={{ background: "#1C1C1C", border: "1px solid rgba(155,163,158,0.2)", color: "#25d366" }}>
              <WAIcon />
            </div>
            <div>
